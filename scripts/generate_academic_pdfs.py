...
def main():
    docs=[
      ...
      (ROOT/"pdf/technical/Software_and_Research_Tools.pdf","Software and Research Tools","Technical Document",[h1("Tools Actually Used"),table([["Tool","Version","Role","Official source"],["LTspice","26.0.2","Transistor-level simulation","analog.com/ltspice"],["Python","Bundled 3.x runtime","Verification, parsing, PDF and figure generation","python.org"],["Git","Installed client","Version control","git-scm.com"],["GitHub","Public repository service","Public dissemination","github.com"],["PTM","65-nm beta model","Predictive transistor model","mec.umn.edu/ptm"],["ReportLab","Bundled Python library","Academic PDF generation","reportlab.com"],["Pillow","Bundled Python library","Research figures","python-pillow.org"]],[32*mm,25*mm,55*mm,62*mm]),h1("Reproducibility Notes"),p("Versions and commands are documented in the repository. Verilog source is included, but no Verilog simulator result is claimed because Icarus Verilog was not installed during this run.")],True),
